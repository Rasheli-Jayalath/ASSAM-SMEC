...
?>
<div id="logo"><a href="index.php"  title="PMIS" >
...
<div id="navcontainer" class="menu">
	...
	<li><a href="javascript:void(0);" style="opacity: 0.5;" class="current" ><?php echo KPI_DASHBOARDS;?></a></li> 
        ...
        <?php if($rescount!=0)
				...
				{
				?>
				<a href="KFI_progress_dashboard.php?itemid_0=1" <?php if($sCurPage=='KFI_progress_dashboard.php?$ki_str') echo 'class="sel"' ; ?>  target="_blank" class="current"><?php echo KFI_DASHBOARDS;?></a>
				<?php
				}
				else
				{
				?>
				<a href="javascript:void(0);" style="opacity: 0.5;" class="current" ><?php echo KFI_DASHBOARDS;?></a>
				<?php
				}
				?>
				</li>
...
{
?>
<a href="sp_design.php" <?php if($sCurPage=='sp_design.php') echo 'class="sel"' ; ?> class="current">Design Progress</a>
<?php
}
else
{
?>
<a href="javascript:void(0);" style="opacity: 0.5;" class="current" >Design Progress</a>
<?php
}
?>
...
<li>
<a href="project_risk_info.php" <?php if($sCurPage=='project_risk_info.php') echo 'class="sel"' ; ?> class="current">Risk Register</a>
</li>
<li>
<a href="daily_site_diary.php" <?php if($sCurPage=='daily_site_diary.php') echo 'class="sel"' ; ?> class="current">Site Diary</a>
</li>        
<?php } else { ?>
        <li>
		<?php  if($pic_flag==1)
		{
		?>
		<a href="javascript:void(0);" <?php if($sCurPage=='analysis.php') echo 'class="sel"' ; ?> class="current" ><?php echo PIC_ANALYSIS;?></a>
		<?php
		}
		else
		{
	...
	<a href="javascript:void(0);" style="opacity: 0.5;" class="current" ><?php echo PIC_ANALYSIS;?></a>
		...
		<li>
			...
			{
			?>
			<a href="javascript:void(0);" <?php if($sCurPage=='dm_drawingmap.php') echo 'class="sel"' ; ?>  class="current"><?php echo MAPS_DRAWINGS;?></a>
			<?php
			}
			else
			{
...
{
?>
<a href="javascript:void(0);" <?php if($sCurPage=='sp_design.php') echo 'class="sel"' ; ?> class="current">Design Progress</a>
<?php
}
else
{
...
?>
        ...
        <li>
			...
			{
			?>
			<a href="javascript:void(0);" <?php if($sCurPage=='project_issues_info.php') echo 'class="sel"' ; ?>  class="current"><?php echo PROJECT_ISS;?></a>
			<?php
			}
			else
			{
        ...
        <li>
			...
			{
			?>
			<a href="javascript:void(0);" <?php if($sCurPage=='project_nonconfirmity_info.php') echo 'class="sel"' ; ?>  class="current"><?php echo NON_CONFON;?></a>
			<?php
			}
			else
			{
...
<li>
<a href="javascript:void(0);" <?php if($sCurPage=='project_risk_info.php') echo 'class="sel"' ; ?> class="current">Risk Register</a>
</li>
<li>
<a href="javascript:void(0);" <?php if($sCurPage=='daily_site_diary.php') echo 'class="sel"' ; ?> class="current">Site Diary</a>
</li>        
